...
pos=0
sfs_lr = SequentialFeatureSelector(model_lr, direction='forward',tol=None, scoring='roc_auc', n_features_to_select=5)
...
sfs_svm = SequentialFeatureSelector(model_svm, direction='forward',tol=None, scoring='roc_auc', n_features_to_select=5)
...
sfs_rf = SequentialFeatureSelector(model_rf, direction='forward',tol=None, scoring='roc_auc', n_features_to_select=5)
...
sfs_ann = SequentialFeatureSelector(model_ann, direction='forward',tol=None, scoring='roc_auc', n_features_to_select=5)
...
sfs_xgb = SequentialFeatureSelector(model_xgb, direction='forward', scoring='roc_auc', tol=None, n_features_to_select=5)
...
sfs_stack = SequentialFeatureSelector(model_stack, direction='forward', scoring='roc_auc', tol=None, n_features_to_select=5)
...
all_result.to_excel(path+'\\all_result_rcvonce_rforward_temp.xlsx')
with open(path+'\\all_result_rcvonce_rforward_temp.pickle', 'wb') as f:
...
pos=pos+1
all_result_retune.to_excel(path+'\\all_result_rcvonce_rforward_retune_temp.xlsx')
with open(path+'\\all_result_rcvonce_rforward_retune_temp.pickle', 'wb') as f:
